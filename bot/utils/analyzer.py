...
_SYSTEM_PROMPTS = {
    "lang_kirill": (
        ...
        "МУҲИМ: Транскрипция қайси тилда бўлишидан қатъий назар, таҳлил ФАҚАТ ўзбек тилида, "
        "кирилл алифбосида ёзилиши ШАРТ. Транскрипцияни таржима қилма, "
        "фақат таҳлилни ўзбек кирилл тилида ёз."
    ),
    "lang_lotin": (
